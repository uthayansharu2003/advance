...
<div class="dashboard-container">
    <!-- SIDEBAR -->
    <aside class="sidebar" style="background: #0f172a;"> <!-- Darker Admin Sidebar -->
        <div class="sidebar-header" style="color: #38bdf8;">👑 Admin Portal</div>
        <ul class="sidebar-menu">
            <li><a href="${pageContext.request.contextPath}/admin/dashboard" class="active">📅 Reservations</a></li>
